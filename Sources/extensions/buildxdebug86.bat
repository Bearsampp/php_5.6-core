cd xdebug-2.5.5
SET XPD_PHP_SRC=..\..\phpdev\vc11\x86\php-5.6.40-src
...
copy /Y %XPD_PHP_SRC%\Release_TS\devel\ %XPD_PHP_SRC%\win32\build\script\
copy /Y %XPD_PHP_SRC%\win32\build\ %XPD_PHP_SRC%\win32\build\script\

md %XPD_PHP_SRC%\win32\build\lib
copy /Y %XPD_PHP_SRC%\Release_TS\php5ts.lib %XPD_PHP_SRC%\win32\build\lib\
